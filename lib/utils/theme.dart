...
const Color mainColor = Color.fromARGB(255, 106, 203, 236);
const Color darkGreyClr = Color.fromARGB(255, 15, 25, 39);
const Color pinkClr = Color.fromARGB(255, 144, 179, 232);
